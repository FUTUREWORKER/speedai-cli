...
description: Generate videos with the Speed AI system Wanx 2.7 video model through the logged-in user's authorization, points billing, task queue, OSS storage, and H5 creation history.
---

# Speed AI 万相 2.7 视频创作
