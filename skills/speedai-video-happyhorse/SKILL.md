...
description: Generate videos with the Speed AI system HappyHorse video model through the logged-in user's authorization, points billing, task queue, OSS storage, and H5 creation history.
---
