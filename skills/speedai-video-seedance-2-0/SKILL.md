---
name: speedai-video-seedance-2-0
description: Generate videos with the Speed AI system Seedance 2.0 video model through the logged-in user's authorization, points billing, task queue, OSS storage, and H5 creation history.
---

# Speed AI Seedance 2.0 视频创作
...
3. 使用 `speedai video generate --series seedance` 提交任务。
